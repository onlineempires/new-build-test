...
export default function MemberFunnels() {
  ...
  return (
    <>
      <Head>
        <title>My Funnels - Online Empires</title>
        <meta name="description" content="Create and manage your affiliate marketing funnels" />
      </Head>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center justify-end space-x-2">
                            ...
                            <button
                              ...
                              title={
                                duplicatingFunnel === funnel.id ? 'Duplicating...' : 'Duplicate'
                              }
                            >
                              {duplicatingFunnel === funnel.id ? (
