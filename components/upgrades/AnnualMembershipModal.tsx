...
interface AnnualMembershipModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function AnnualMembershipModal({ 
  isOpen, 
  onClose, 
  currentPlan = 'free',
  onUpgradeSuccess 
}: AnnualMembershipModalProps) {
  ...
  const planDetails = {
    'annual': {
      ...
      savingsAmount: `Save $${(99 * 12 - 799).toFixed(0)}`,
      features: [
      ...
      if (paymentMethod === 'apple-pay') {
        const paymentRequest = {
          ...
          total: {
            ...
            amount: selectedPlan === 'annual' ? '799.00' : '79.00'
          }
        };
        ...
        setTimeout(() => {
          setIsProcessing(false);
          // Grant Annual Membership entitlements
          localStorage.setItem('userRole', 'annual');
          localStorage.setItem('purchaseData', JSON.stringify({
            plan: 'annual',
            sku: planDetails[selectedPlan].sku,
            entitlements: ['courses', 'masterclasses', 'community', 'stats'],
  ...
  const getButtonText = () => {
    ...
    if (selectedPlan === 'annual') return 'Pay $799/year';
    return 'Pay $99/month';
  };
    ...
    <div className="fixed inset-0 bg-black/60 z-[1050] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-[92vw] max-w-[720px] rounded-3xl p-6 md:p-8 shadow-2xl z-[1060] max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Get full access to courses, masterclasses, and exclusive benefits</p>
        </div>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    {planKey === 'annual' && (plan as any).savings && (plan as any).savingsAmount && (
                      <div className="text-sm text-green-600 font-medium">{(plan as any).savings} - {(plan as any).savingsAmount}</div>
                    )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-2">
                  <input
                    ...
                    className="w-full h-11 rounded-xl border border-slate-200 px-3 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    maxLength={19}
                  />
                </div>
        ...
        <div className="bg-gray-50 rounded-xl p-4 mb-6">
          <div className="flex justify-between items-center">
            ...
            <span className="font-bold text-gray-900">
              {planDetails[selectedPlan].price}{planDetails[selectedPlan].subtitle}
            </span>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full h-12 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold rounded-2xl transition-colors flex items-center justify-center"
        >
          {isProcessing && (
